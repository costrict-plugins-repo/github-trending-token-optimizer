...
exports.resolveReadCacheMode = resolveReadCacheMode;
 ...
 */
function readReadCacheConfigFile() {
...
function isReadCacheDisabled() {
    ...
    if (envVal === undefined) {
        ...
        if (readReadCacheConfigFile().read_cache_enabled === false)
            return true;
    }
    return false;
}
